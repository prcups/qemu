...
static void loongson_ipi_realize(DeviceState *dev, Error **errp)
{
    ...
    LS2KIPIState *s = LS2K_IPI(dev);
    LS2KIPIClass *lic = LS2K_IPI_GET_CLASS(dev);
...
{
    LS2KIPIState *s = LS2K_IPI(dev);
    LS2KIPIClass *k = LS2K_IPI_GET_CLASS(dev);
...
static void loongson_ipi_class_init(ObjectClass *klass, const void *data)
{
    ...
    LS2KIPIClass *lic = LS2K_IPI_CLASS(klass);
...
static const TypeInfo loongson_ipi_types[] = {
    {
        ...
        .instance_size      = sizeof(LS2KIPIState),
        .class_size         = sizeof(LS2KIPIClass),
